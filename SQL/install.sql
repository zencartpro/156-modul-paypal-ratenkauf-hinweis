####################################################################
# PayPal Ratenkauf Hinweis 1.0.0 - Install - 2021-09-24 - webchills
####################################################################
...
('PayPal Pay Later - Minimum Value', 'PAYPAL_PAY_LATER_VALUE', '100', 'Enter here the amount from which the note should be displayed at the price on the item detail, shopping cart and checkout payment page:.', @gid, 5, NOW(), NULL, NULL),
...
('PayPal Ratenkauf - Hinweis Layout', 'PAYPAL_PAY_LATER_LAYOUT', 'W?hlen Sie das Layout des Hinweises:<br/><br/>primary = PayPal Logo links<br/>inline = PayPal Logo inline<br/>alternative = kleines PayPal Monogramm links<br/>none = kein PayPal Logo<br/><br/>',	43),
('PayPal Ratenkauf - Textfarbe', 'PAYPAL_PAY_LATER_COLOR', 'W?hlen Sie die Textfarbe des Hinweises:<br/><br/>black = schwarz<br/>white = weiss (nur sinnvoll bei dunklem Hintergrund)<br/><br/>',	43),
('PayPal Ratenkauf - Client ID', 'PAYPAL_PAY_LATER_CLIENT_ID', 'Geben Sie hier Ihre PayPal Client ID ein:',	43),
('PayPal Ratenkauf - Minimaler Wert', 'PAYPAL_PAY_LATER_VALUE', 'Geben Sie hier den Betrag ein, ab dem der Hinweis beim Preis auf der Artikeldetailseite, im Warenkorb und auf der Zahlungsartauswahlseite angezeigt werden soll.<br/>PayPal Ratenkauf ist generell erst ab einem Betrag von 99 Euro vorgesehen, daher macht hier nur ein Wert von mehr als 100 Euro Sinn.',	43),
