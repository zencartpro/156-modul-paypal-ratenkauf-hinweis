 ...
 * @version $Id: tpl_product_info_display.php for PayPal Ratenkauf Hinweis 2021-09-23 17:20:36Z webchills $
 */
...
<?php if (($specials_new_products_price >=  PAYPAL_PAY_LATER_VALUE) && ($specials_new_products_price <=  PAYPAL_PAY_LATER_VALUE_MAX)) {?>
<div id="paypalratenkauf">
<div
    data-pp-message
    data-pp-style-layout="text"
    data-pp-style-logo-type="<?php echo PAYPAL_PAY_LATER_LAYOUT;?>"
    data-pp-style-text-color="<?php echo PAYPAL_PAY_LATER_COLOR;?>"
    data-pp-amount="<?php echo $specials_new_products_price = (round(zen_add_tax(zen_get_products_actual_price($product_info_metatags->fields['products_id']),zen_get_tax_rate($product_info_metatags->fields['products_tax_class_id'])),2)); ?>">
</div>
</div>
<?php } ?>
<?php } ?>
