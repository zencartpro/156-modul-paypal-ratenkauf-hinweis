 ...
 * @version $Id: tpl_checkout_payment_default.php for Paypal Ratenkauf Hinweis 2021-09-23 18:08:42Z webchills $
 */
?>
...
<?php if (($_SESSION['cart']->show_total() >=  PAYPAL_PAY_LATER_VALUE) && ($_SESSION['cart']->show_total() <=  PAYPAL_PAY_LATER_VALUE_MAX)) {?>
<div id="paypalratenkaufpayment">
<div
    data-pp-message
    data-pp-style-layout="text"
    data-pp-style-logo-type="<?php echo PAYPAL_PAY_LATER_LAYOUT;?>"
    data-pp-style-text-color="<?php echo PAYPAL_PAY_LATER_COLOR;?>"
    data-pp-amount="<?php echo $order->info['total']; ?>">
</div>
</div>
<br class="clearBoth" />
<?php } ?>
